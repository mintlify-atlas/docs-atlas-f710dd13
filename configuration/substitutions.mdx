---
title: "Template Substitutions in melange Build Files"
...
| `${{package.srcdir}}` | The source directory inside the build sandbox (`/home/build` by default, or the value of `--source-dir`) |
